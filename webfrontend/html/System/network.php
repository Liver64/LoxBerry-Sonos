...
DATA;
	...
	$diffarray = array_diff_assoc($sonosplayer, $sonosnet);
	// add newly scanned zones to array
	$finalzones = array_merge($sonosnet, $diffarray);
	#return $finalzones;
	#print_r($finalzones);
	#---------------------
	# Version mit speichern der array als JSON Datei
