...
class POLLY_TTS{
    ...
    private $utc_tz      = "";
    #private $access_key  = $config['TTS']['API-key'];
	private $access_key  = "GDNAIZLZP27VD2ZOA6NQ";
    #private $secret_key  = $config['TTS']['secret-key'];
	private $secret_key  = "ABHjo2NcLZkUyb2+kNI6G99J0JKJRYidzY/4qVpV";
	private $region      = "de-DE"; 
    private $voice       = "Marlene";
