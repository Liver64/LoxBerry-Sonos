<?php
/**
 * Sonos4Lox - Support Error Handler
 * Version: ERROR_HANDLER_RELOCATION_V01_2026_06_15
 *
 * Relocated to src/Support/ErrorHandler.php.
 * Keeps the existing handleError(), fileLog() and mapErrorCode() behavior.
 */
