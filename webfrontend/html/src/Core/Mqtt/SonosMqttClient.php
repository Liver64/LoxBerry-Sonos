...
/**
 * Sonos4Lox minimal MQTT 3.1.1 client
 * Version: SONOS_MQTT_CLIENT_CORE_RELOCATION_V01_2026_06_13
 *
 * Purpose:
 * - TCP socket based MQTT publishing.
 * - QoS 0/1.
 * - Clean session.
 * - KeepAlive with PINGREQ/PINGRESP.
 *
 * This class intentionally keeps using the caller-provided global logln($level, $message)
 * function because it is currently used by src/Core/Event/EventHandler.php.
 */
