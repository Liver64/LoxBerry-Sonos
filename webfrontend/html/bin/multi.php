...
// Common includes or setup here (optional)
...
function push_maxvol() {
    ...
    echo "Running push_maxvol()\n";
}

function tv_monitor() {
	
	global $time_start, $Stunden; 
    ...
    echo "Running tv_monitor()\n";
}

function on_time() {
	
	global $sonoszonen, $time_start, $folfilePlOn; 
    ...
    echo "Running on_time()\n";
}

// Funktion anhand von Argument aufrufen
$function = $argv[1] ?? '';
...
switch ($function) {
    ...
    case 'on_time':
        ...
        break;
    default:
        echo "Usage: php multi_task.php {push_maxvol|tv_monitor|on_time}\n";
        exit(1);
}
